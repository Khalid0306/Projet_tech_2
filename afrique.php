...
#disponibles {
  background-image: url(img/vogue1.webp);
  background-size: cover;
  background-position: center;
  background-repeat: no-repeat;
...
#rs {
  background-image: url(img/vogue2.jpg);
  background-size: cover;
  background-position: center;
  background-repeat: no-repeat;
...
<div class="container">
  <div id="electrique" class="section">
    <div class="content">
      <h1>Découvrez notre rebrique 
        100/%  MODE </h1>
      <h4><a href="sape.php">Decouvrez la Mode Comme Jamais .</a></h4>
    </div>
  ...
  <div id="disponibles" class="section">
    ...
    <h1>Nos modèles disponibles immédiatement</h1>
      <h4><a href="sape.php">Accedez a la boutique et decouvrez.</a></h4>
    </div>
    <div class="overlay"></div>
  </div>
...
<div class="product">
    ...
    $sql = "SELECT * FROM produit WHERE id_produit  IN( 92,93,94,95,95,96,97,98,99,100,101)";
    $sth = $bdd->prepare($sql);
    $sth->execute();

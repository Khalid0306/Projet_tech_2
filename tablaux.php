...
<div class="container">
  <div id="electrique" class="section">
    <div class="content">
      <h1>Découvrez notre rebrique 
        100/%  peinture </h1>
      <h4><a href="b.php">Decouvrez la peinture Comme Jamais .</a></h4>
    </div>
  ...
  <div id="disponibles" class="section">
    ...
    <h1>Nos modèles disponibles immédiatement</h1>
      <h4><a href="b.php">Accedez a la boutique et decouvrez.</a></h4>
    </div>
    <div class="overlay"></div>
  </div>
...
<div class="row">
  <div class="col-sm-4"> <span> <div class="rhombus"></div></span>
    <h1>VOGUE</h1>
      ...
      <h4><a href="b.php">Decouvrez notre 
...
<div class="product">
    ...
    $sql = "SELECT * FROM produit WHERE id_produit  IN(87,88,89,90,91)";
    $sth = $bdd->prepare($sql);
    $sth->execute();

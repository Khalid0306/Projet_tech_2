...
<nav>
  ...
  <div id="menu" class="col-md-10">
        ...
        <li><a href="#" id="logout-link">log out</a></li>
			<li style="display: none;"><a href="#" id="preview-link1">Lien 1</a></li>
			<li style="display: none;"><a href="#" id="preview-link2">Lien 2</a></li>
...
#electrique {
  background-image: url(img/intro10.jpg);
  background-size: cover;
  background-position: center;
...
#disponibles {
  background-image: url(img/tableaux6.jpg);
  background-size: cover;
  background-position: center;
  background-repeat: no-repeat;
...
#rs {
  background-image: url(img/intro7.webp);
  background-size: cover;
  background-position: center;
  background-repeat: no-repeat;
